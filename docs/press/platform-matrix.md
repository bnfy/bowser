...
| Windows x64 | Workflow now refuses unsigned output and verifies both Authenticode validity and expected publisher; GitHub credential/secrets and current Windows 11 install/SmartScreen state were not available to verify locally | Not release-eligible |
